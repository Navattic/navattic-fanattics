          ...
          <div className="text-sm font-medium text-gray-800">
            ...
            >
              <span className="flex items-center text-sm font-medium">
                <div className="box-shadow-[0px_-1px_1px_0px_hsla(226,88%,22%,0.14)_inset,0px_1px_2px_0px_hsla(204,100%,98%,0.5)_inset] flex items-center gap-1 rounded-lg border border-blue-100 bg-gradient-to-b from-blue-50 to-blue-100 px-2 py-0.5">
